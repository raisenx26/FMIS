...
<body>
    ...
    <div id="content">
        ...
        <div id="header2">
            <div id="obli">
                <b>BUDGET UTILIZATION REQUEST & STATUS<b>
            </div>
            <div id="numdate">
                <div id="num">
                    <p><b>No:
                            {{ str_replace("/", "-", request()->reg_ors) . request()->reg_date . request()->print_reg_ors2 }}
                        </b></p>
                </div>
                <div id="date">
        ...
        <div id="description1">
            <table width="100.1%" id="table1">
                <tr>
                    ...
                    <th id="th1" width="40%">Particulars
                        </th>
