...
<form  method="GET" action="{{ route('monthly_summary_print',$data->monthly_id) }}">
    ...
    {{-- S&T Services add new  --}}
    <div class="container">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th width="42%">
            &nbsp;&nbsp;&nbsp;<a onclick=myFunction3() href="#"><span><i class="fa fa-plus my-float"></i></span> Add new Regional S & T Services</a>
            </th>
    ...
    <div class="container">  
    <table class="table table-bordered" id="myTable4"{{$data->monthly_id}}>
    </table>
    <input id="counter3" name="counter3" class="form-control" type="hidden">
...
<div class="container">
    ...
    {{-- Other Compensation add new  --}}
    <div class="container">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th width="42%">
            &nbsp;&nbsp;&nbsp;<a onclick=myFunction4() href="#"><span><i class="fa fa-plus my-float"></i></span> Add new Other Compensation</a>
            </th>
            <th width="12.5%">UACS code</th>
            <th width="11.5%">Authorized Appropriations</th>
            <th width="11.5%"> Allotment Recieved</th>
    ...
    <div class="container">  
    <table class="table table-bordered" id="myTable5"{{$data->monthly_id}}>
    </table>
    <input id="counter4" name="counter4" class="form-control" type="hidden">
    <span id="output-area"></span>
    </div>
 ...
 <div class="container">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th width="42%">
        &nbsp;&nbsp;&nbsp;<a onclick=myFunction5() href="#"><span><i class="fa fa-plus my-float"></i></span> Add new MC Benifit</a>
        </th>
        <th width="12.5%">UACS code</th>
        <th width="11.5%">Authorized Appropriations</th>
        <th width="11.5%"> Allotment Recieved</th>
...
<input id="counter5" name="counter5" class="form-control" type="hidden">
<span id="output-area"></span>
</div>
 ...
 <div class="container">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th width="42%">
        &nbsp;&nbsp;&nbsp;<a onclick=myFunction6() href="#"><span><i class="fa fa-plus my-float"></i></span> Add new MOOE</a>
        </th>
        <th width="12.5%">UACS code</th>
        <th width="11.5%">Authorized Appropriations</th>
        <th width="11.5%"> Allotment Recieved</th>
...
<input id="counter6" name="counter6" class="form-control" type="hidden">
<span id="output-area"></span>
</div>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          <td width="43%"><b><u>Capital Outlay</u></b><br>
          ICT Equipment <br><br>
          ICT Software <br>
        </td>
        <td>
        ...
        <td>
            <br>
            <input name="aa_ict_equip" class="form-control" value="{{ $data->ict_equip }}">
            <input name="aa_ict_sotfware" class="form-control" value="{{ $data->ict_software }}">
        </td>
        <td>
            <br>
            <input name="ar_ict_equip" class="form-control" value="{{ $data->ict_equip }}">
            <input name="ar_ict_sotfware" class="form-control" value="{{ $data->ict_software }}">
        </td>
        </tr>
      </tbody>
      </table>
...
<button  id="close" type="button" class="btn btn-secondary" href="#" onclick="history.go(-1)">Close</button>
</form>
...
<script>
   ...
   // var dataz = {!! json_encode($data->monthly_id) !!};
    ...
    {
      document.getElementById('counter3').value = ++z;
      ...
      var cell5 = row.insertCell(4);
      var cell6 = row.insertCell(5);
      cell1.innerHTML = '<div style="width:448px;"><textarea rows="2" class="form-control" placeholder="Description" name="description_new3[]" type="text"></textarea></div>';
      cell2.innerHTML = '<div style="width:120px;"><input class="form-control" placeholder="UACS code" name="uacs_new3[]" type="text"></div>';
      cell3.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Authorized Appropriations"  name="aa_new3[]"></div>';
      cell4.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Allotment Recieved"  name="ar_new3[]" ></div>';
      cell5.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(This reprot)"  name="tr_new3[]" ></div>';
      cell6.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(To Date"  name="td_new3[]" ></div>';
    }

    function myFunction4() 
    {
      document.getElementById('counter4').value = ++a;
      ...
      var cell5 = row.insertCell(4);
      var cell6 = row.insertCell(5);
      cell1.innerHTML = '<div style="width:448px;"><textarea rows="2" class="form-control" placeholder="Description" name="description_new4[]" type="text"></textarea></div>';
      cell2.innerHTML = '<div style="width:120px;"><input class="form-control" placeholder="UACS code" name="uacs_new4[]" type="text"></div>';
      cell3.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Authorized Appropriations"  name="aa_new4[]"></div>';
      cell4.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Allotment Recieved"  name="ar_new4[]" ></div>';
      cell5.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(This reprot)"  name="tr_new4[]" ></div>';
      cell6.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(To Date"  name="td_new4[]" ></div>';
    }

    function myFunction5() 
    {
      document.getElementById('counter5').value = ++b;
      ...
      var cell5 = row.insertCell(4);
      var cell6 = row.insertCell(5);
      cell1.innerHTML = '<div style="width:448px;"><textarea rows="2" class="form-control" placeholder="Description" name="description_new5[]" type="text"></textarea></div>';
      cell2.innerHTML = '<div style="width:120px;"><input class="form-control" placeholder="UACS code" name="uacs_new5[]" type="text"></div>';
      cell3.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Authorized Appropriations"  name="aa_new5[]"></div>';
      cell4.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Allotment Recieved"  name="ar_new5[]" ></div>';
      cell5.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(This reprot)"  name="tr_new5[]" ></div>';
      cell6.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(To Date"  name="td_new5[]" ></div>';
    }

    function myFunction6() 
    {
      document.getElementById('counter6').value = ++c;
      ...
      var cell5 = row.insertCell(4);
      var cell6 = row.insertCell(5);
      cell1.innerHTML = '<div style="width:448px;"><textarea rows="2" class="form-control" placeholder="Description" name="description_new6[]" type="text"></textarea></div>';
      cell2.innerHTML = '<div style="width:120px;"><input class="form-control" placeholder="UACS code" name="uacs_new6[]" type="text"></div>';
      cell3.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Authorized Appropriations"  name="aa_new6[]"></div>';
      cell4.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Allotment Recieved"  name="ar_new6[]" ></div>';
      cell5.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(This reprot)"  name="tr_new6[]" ></div>';
      cell6.innerHTML = '<div style="width:105px;"><input type="number" step="0.01" class="form-control" placeholder="Obligations Incurred(To Date"  name="td_new6[]" ></div>';
    }
